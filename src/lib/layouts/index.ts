...
import { LAYOUT_THANK_MINIMAL } from './layoutThankMinimal';
import { LAYOUT_THANK_POLAROID } from './layoutThankPolaroid';
...
export { templateToTheme, formatGreeting, applyName, toGreeting } from './types';

export const LAYOUTS: LayoutMeta[] = [
  LAYOUT_CLASSIC,
  LAYOUT_THANK_CLASSIC,
  LAYOUT_THANK_MINIMAL,
  LAYOUT_THANK_POLAROID,
  LAYOUT_7,
  LAYOUT_4,
  LAYOUT_3,
  LAYOUT_6,
