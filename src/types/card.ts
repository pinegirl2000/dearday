...
export type BackgroundId = 'bg-none' | 'bg-1' | 'bg-2' | 'bg-3' | 'bg-4' | 'bg-img-1' | 'bg-img-2' | 'bg-img-3' | 'bg-img-4' | 'bg-img-6' | 'bg-img-7' | 'bg-img-8' | 'bg-img-9' | 'bg-img-10' | 'bg-img-11' | 'bg-img-12' | 'bg-img-13' | 'bg-img-14' | 'bg-img-15' | 'bg-img-16' | 'bg-img-17' | 'bg-img-18' | 'bg-img-19';
...
export type EnvelopeAnimId = 'envelope-1' | 'envelope-2' | 'envelope-3' | 'envelope-4' | 'envelope-5' | 'none';
