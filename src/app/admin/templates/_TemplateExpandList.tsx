...
function buildPreview(t: Tpl): BaseCard {
  return {
    id: 'preview',
    slug: 'preview',
    event_type: 'etc',
                ...
                >
                  <div className="p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-[11px]">
                      ...
                      <InfoRow label="Layout" value={`${layout.name} (${t.layout_id})`} />
                      <InfoRow label="Render style" value={layout.renderStyle} mono />
                      <InfoRow label="Aspect" value={layout.aspectRatio} mono />
                    </div>
